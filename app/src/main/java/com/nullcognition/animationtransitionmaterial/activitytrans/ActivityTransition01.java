...
public class ActivityTransition01 extends AppCompatActivity{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		mBackground = new ColorDrawable(Color.CYAN);
	...
	public void runEnterAnimation(){
		final long duration = (long) (ANIM_DURATION * ActivityTransition00.sAnimatorScale);
		...
		ObjectAnimator colorizer = ObjectAnimator.ofFloat(ActivityTransition01.this,
				"saturation", 0, 1);
				         ...
				         withEndAction(new Runnable(){
					         public void run(){
						         ...
						         ObjectAnimator colorizer =
								         ObjectAnimator.ofFloat(ActivityTransition01.this,
										         "saturation", 1, 0);
						         colorizer.setDuration(duration);
						         colorizer.start();
					         }
